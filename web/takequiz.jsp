    ...
    <body>
        <div id="main-panel">
            ...
            <div id="main-content">
                ...
                <h1 id="fornTitle">Welcome <span class="userName">${sessionScope.user.name}</span></h1>


                <form action="TakeQuiz" method="post">

                    Enter number of question: </br>
                    <div><input type="text" value="${sessionScope.questions.size()}" id="numQuiz" name="numQuiz"></div>

                    <div class="startBtn">  <input type="submit" value="Start"></div>
